...
class VMWriter:
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        """
        mapped_segment = self.segment_map.get(segment, segment.lower())
        self.output_stream.write(f"push {mapped_segment} {index}\n")
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        """
        mapped_segment = self.segment_map.get(segment, segment.lower())
        self.output_stream.write(f"pop {mapped_segment} {index}\n")
